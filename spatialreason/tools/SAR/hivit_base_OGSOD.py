...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/home/vgc/users/lwj/detection_hivit/detection/data/OGSOD/Annotations/train.json',
        img_prefix=
        '/home/vgc/users/lwj/detection_hivit/detection/data/OGSOD/JPEGImages/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=False),
            dict(type='RandomFlip', flip_ratio=0.5),
    ...
    val=dict(
        type='CocoDataset',
        ann_file=
        '/home/vgc/users/lwj/detection_hivit/detection/data/OGSOD/Annotations/test.json',
        img_prefix=
        '/home/vgc/users/lwj/detection_hivit/detection/data/OGSOD/JPEGImages/',
        pipeline=[
            dict(type='LoadImageFromFile'),
...
pretrained = '/home/vgc/users/lwj/detection_hivit/detection/checkpoint-600.pth'
fp16 = None
default_hooks = dict(checkpoint=dict(type='CheckpointHook', interval=36))
work_dir = './work_dirs/OGSOD_new'
auto_resume = False
gpu_ids = range(0, 8)
